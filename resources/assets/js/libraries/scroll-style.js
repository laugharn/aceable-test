export default (function(document, window) {
  ...
  var scrollPosY = 0,
      ...
      elements = document.getElementsByClassName("+scroll-style");
  ...
  function aboveScrollPos() {
    ...
    for (var i = 0; elements[i]; ++i) { // chrome workaround
      ...
      elements[i].classList.add("--scrolled-above");
      elements[i].classList.remove("--scrolled-below");
    }
  ...
  function belowScrollPos() {
    ...
    for (var i = 0; elements[i]; ++i) { // chrome workaround
      // add style / class to element
      elements[i].classList.add("--scrolled-below");
      elements[i].classList.remove("--scrolled-above");
    }
